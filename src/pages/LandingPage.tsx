        ...
        <div className="md:col-span-5">
          <div className="bg-zinc-950 border border-zinc-850 p-8 rounded-lg flex flex-col h-full shadow-2xl">
            ...
            <div className="grid grid-cols-3 gap-2 border-t border-zinc-900 mt-8 pt-6">
              <div>
                <span className="text-[8px] text-zinc-600 font-black uppercase block tracking-wider mb-1">Volunteers</span>
                <span className="text-lg font-black font-mono text-white">14,208</span>
              </div>
              <div>
                <span className="text-[8px] text-zinc-600 font-black uppercase block tracking-wider mb-1">Resolved</span>
                <span className="text-lg font-black font-mono text-emerald-500">921</span>
              </div>
              <div>
                <span className="text-[8px] text-zinc-600 font-black uppercase block tracking-wider mb-1">Avg Response</span>
      ...
      <div className="bg-zinc-950 border-t border-zinc-900 py-10 px-6 mt-12">
        <div className="max-w-7xl mx-auto flex flex-col gap-6">
          <div className="flex justify-between items-center pb-4 border-b border-zinc-900">
            ...
            <span className="text-[9px] font-mono text-zinc-600 uppercase">Updates real-time via local ledger</span>
          </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {localFeedIssues.map((issue) => (
              <div 
                ...
                className="bg-black border border-zinc-850 hover:border-red-600 p-4 rounded cursor-pointer transition-colors flex flex-col gap-3 group"
              >
                <div className="relative aspect-square rounded overflow-hidden">
                  ...
                  {issue.anonymous && (
                    <div className="absolute top-2 left-2 bg-black/80 px-1.5 py-0.5 rounded flex items-center gap-1 border border-zinc-800">
                      ...
                      <span className="text-[7px] text-zinc-400 font-black uppercase">Anon</span>
                    </div>
                  )}
                ...
                <div>
                  ...
                  <span className="text-[8.5px] font-mono text-zinc-500 uppercase mt-1 block">{issue.location.area} · {issue.location.city}</span>
        ...
        <div id="issue-detail-scroller" className="bg-black border-t border-zinc-900 py-16 px-6">
          <div className="max-w-4xl mx-auto">
            <div className="flex justify-between items-center mb-6">
              <span className="text-xs font-black uppercase tracking-widest text-zinc-500">Incident Inspection Core</span>
              <button onClick={() => setSelectedIssueId(null)} className="text-[10px] font-black uppercase tracking-wider text-red-500 hover:text-white">
                [Close Inspection]
              </button>
            </div>
            <IssueDetailPanel 
