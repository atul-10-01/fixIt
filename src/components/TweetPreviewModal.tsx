    ...
    <div className="fixed inset-0 bg-black/85 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-[#0f1419] border border-zinc-800 w-full max-w-lg rounded-xl overflow-hidden flex flex-col">
        ...
        <div className="p-6 flex flex-col gap-5">
          ...
          <div className="bg-[#15181c] border border-zinc-800 p-5 rounded-xl flex gap-3.5 relative">
            <span className="absolute top-3 right-3 text-[7.5px] bg-red-600/10 text-red-500 border border-red-500/20 px-2 py-0.5 font-bold uppercase tracking-wider rounded">
              Demo Simulation Block
            </span>

            {/* Avatar */}
            <div className="w-10 h-10 rounded-full bg-red-600/20 border border-red-500 flex items-center justify-center font-black text-white text-xs select-none">
              FI
            </div>
            ...
            <div className="flex-grow">
              ...
              {/* Text */}
              <p className="text-[11px] text-zinc-300 mt-2 font-mono leading-relaxed select-all">
                {tweetText}
              </p>
          ...
          <div className="flex flex-col gap-2">
            {tweeted ? (
              ...
              <button 
                ...
                className="bg-[#1d9bf0] hover:bg-[#1a8cd8] text-white font-black uppercase text-xs py-3.5 tracking-widest transition-colors rounded-lg flex items-center justify-center gap-2"
              >
                <Send className="w-4 h-4" />
                <span>Broadcasting Social Pressure Tweet</span>
              </button>
            )}
          </div>
        </div>
